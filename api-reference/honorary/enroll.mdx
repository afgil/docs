...
|-----------|------|-----------|-------------|
| `master_entity_id` | integer | Sí | ID de la entidad emisora para la cual se gestiona el autorizado |
...
| Parámetro | Tipo | Requerido | Descripción |
|-----------|------|-----------|-------------|
| `action` | string | No | Acción a realizar: `"enroll"` (por defecto) o `"unenroll"` |
