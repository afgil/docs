...
#### Tipo de documento:
- `dte_type`: Objeto con información del tipo de DTE
  - `dte_type.code`: Código numérico del tipo de DTE (ej: 33 para Factura Electrónica)
  - `dte_type.description`: Descripción del tipo de DTE
- `dte_type_description`: Descripción del tipo de DTE (campo adicional para compatibilidad)
