...
Usa el campo `credential_type` para indicar el tipo de credencial (recomendado). Tambien se acepta `credential_type_id` numerico por compatibilidad. Consulta la [referencia completa de tipos de credenciales](/user-guide/credential-types) para mas detalles.
