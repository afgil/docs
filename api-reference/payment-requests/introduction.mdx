...
El sandbox usa el ambiente de integración de Transbank. Puedes probar el flujo completo — pagos, webhooks y emisión de documentos — sin mover dinero real ni emitir DTEs al SII.
