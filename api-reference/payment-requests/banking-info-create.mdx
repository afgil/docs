...
- Cada destinatario tiene **una sola** cuenta bancaria activa. Para cambiar los datos, usá `PUT /api/master-entities/{master_entity_id}/banking-info/`.
...
- **`bank`**: ID interno del banco en Tu Pana. Útil si ya consumiste `GET /api/banks/`. El ID puede variar entre ambientes.
