...
<Info>
Hoy las tarjetas se inscriben desde el frontend de Tu Pana (no hay endpoint público de inscripción). Este endpoint te sirve para consultar el estado actual.
</Info>
