...
- La entidad se indica con el query param `master_entity_id`, igual que en `/documents`. Acepta el **id opaco** (`eid_...`) que entrega `/master-entities?rut=` o el id entero legacy.
