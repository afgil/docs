...
| `principal_rut` | String | RUT de la empresa mandante, la dueña de la venta. Se acepta con o sin puntos |
...
- Un `principal_rut` inválido se rechaza en la entrada.
