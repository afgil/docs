---
title: 'Paso a Paso'
description: 'Comienza a usar Tupana en minutos'
---
...
- **document.unpaid**: Cuando el documento vuelva de pagado a no pagado (se revierta el pago/conciliación)
