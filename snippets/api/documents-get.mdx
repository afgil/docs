...
Si al crear el documento enviaste `additional_info`, la respuesta lo devuelve en el campo `additional_info` (`null` si no se envió). Es el texto que se imprime en el recuadro "Información adicional" del PDF; no forma parte del XML enviado al SII.
